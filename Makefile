...
.PHONY: test
test:
	cd ${ROOT_DIR} && TZ='America/Chicago' LOG_DEBUG=1 LOG_TRACE=0 LOG_INFO=1 TS_NODE_COMPILER_OPTIONS='{"module": "commonjs"}' npx mocha --timeout 15000 -r ts-node/register 'test/**/*.test.ts'
